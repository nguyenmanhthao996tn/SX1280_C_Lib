...
double SX1280::GetRangingResult(RadioRangingResultTypes_t resultType)
{
    ...
    case PACKET_TYPE_RANGING:
        ...
        valLsb = (((uint32_t)ReadRegister(REG_LR_RANGINGRESULTBASEADDR) << 16) | ((uint32_t)ReadRegister(REG_LR_RANGINGRESULTBASEADDR + 1) << 8) | ((uint32_t)ReadRegister(REG_LR_RANGINGRESULTBASEADDR + 2)));
